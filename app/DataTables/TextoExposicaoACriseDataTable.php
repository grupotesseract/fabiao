...
class TextoExposicaoACriseDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'texto_exposicao_a_crises.datatables_actions');
    }
     ...
     */
    public function query(TextoExposicaoACrise $model)
    {
    ...
    {
        return 'texto_exposicao_a_crisesdatatable_' . time();
    }
}
