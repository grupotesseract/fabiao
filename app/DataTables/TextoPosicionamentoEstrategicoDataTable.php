...
class TextoPosicionamentoEstrategicoDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'texto_posicionamento_estrategicos.datatables_actions');
    }
     ...
     */
    public function query(TextoPosicionamentoEstrategico $model)
    {
    ...
    {
        return 'texto_posicionamento_estrategicosdatatable_' . time();
    }
}
