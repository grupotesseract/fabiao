...
class TextosCuboDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'textos_cubos.datatables_actions');
    }
     ...
     */
    public function query(TextosCubo $model)
    {
    ...
    {
        return 'textos_cubosdatatable_' . time();
    }
}
