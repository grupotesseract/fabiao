...
class TextoPosicaoFinanceiraDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'texto_posicao_financeiras.datatables_actions');
    }
     ...
     */
    public function query(TextoPosicaoFinanceira $model)
    {
    ...
    {
        return 'texto_posicao_financeirasdatatable_' . time();
    }
}
