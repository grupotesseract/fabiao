...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::select('texto_resposta_1', ['Forte' => 'Forte', 'Fraca' => 'Fraca'], $textoPosicaoFinanceira->texto_resposta_1, ['class' => 'form-control']) !!}
</div>

<!-- Texto Resposta 2 Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('texto_resposta_2', 'Texto Resposta 2:') !!}
    {!! Form::select('texto_resposta_2', ['Forte' => 'Forte', 'Fraca' => 'Fraca'], $textoPosicaoFinanceira->texto_resposta_2, ['class' => 'form-control']) !!}
</div>
